...
class Mail_RFC822
{
    ...
    */
    ...
    function parseAddressList($address = null, $default_domain = null, $nest_groups = null, $validate = null, $limit = null)
    {
        ...
        for($i = 0; $i < sizeof($this->addresses); $i++){
    ...
    function _splitAddresses($address)
    {
        ...
        if(!empty($this->limit) AND sizeof($this->addresses) == $this->limit){
            return '';
        }
    ...
    function _isGroup($address)
    {
        ...
        if(sizeof($parts = explode(':', $string)) > 1){
    ...
    function _validatePhrase($phrase)
    {
        ...
        for($i = 0; $i < sizeof($phrase_parts); $i++){
            // If quoted string:
    ...
    function _validateDomain($domain)
    {
        ...
        while(sizeof($subdomains) > 0){
            $sub_domains[] = $this->_splitCheck($subdomains, '.');
            for($i = 0; $i < $this->index + 1; $i++)
                array_shift($subdomains);
        }

        for($i = 0; $i < sizeof($sub_domains); $i++){
